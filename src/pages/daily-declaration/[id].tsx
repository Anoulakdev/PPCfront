...
import { Customer, User } from '../daily-dispatch/[id]'
...
const Dailydadform = () => {
  ...
  const handleSubmit = async () => {
    ...
    // console.log(total())
    try {
      await acknowledgedDayDispatch({
        variables: {
          acknowledgedDayDispatchInput: newData
        }
      })
    } catch (error) {
      console.log(error)
      ...
      <Grid item xs={12}>
        <Card>
          ...
          >
            ...
            <Typography sx={{ textAlign: 'center', fontWeight: 'bold' }}>Daily Availability Declaration</Typography>
