...
import { WEEK_DIS, WEEK_SUMMARY_ENERGY } from '@/lib/query'
...
const DailyDeclaration = () => {
  ...
  // Query
  const { data, loading: loadingData } = useQuery(WEEK_DIS, {
    variables: {
      queryInput: {
        ...
        search: {
          q: value,
          searchField: ['ID', 'Customer', 'DateTime']
        }
      }
    },
  ...
  const weekDeclarations = data?.weekDispatchs ? data?.weekDispatchs : []
