...
const unit = dayOfWeekArr.length
const steps = [
  {
    title: 'Power Source',
...
const StepperLinearWithValidation = () => {
  ...
  const [createWeekPowerPurchase, { loading: createLoading }] = useMutation(CREATE_WEEK_DECLARATION, {
    onCompleted: data => {
      if (data.createWeekPowerPurchase) {
        setDeclaration(data.createWeekPowerPurchase.decCustomerId)
        setDispatch(data.createWeekPowerPurchase.disCustomerId)
