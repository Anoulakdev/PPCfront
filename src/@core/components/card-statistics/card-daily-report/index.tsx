...
// ** Type Import
import { CardDailyReportProps } from 'src/@core/components/card-statistics/types'
...
const CardDailyReport = (props: CardDailyReportProps) => {
  // ** Props
  const {
    sx,
    title2,
        ...
        <Box sx={{ mb: 3.5, gap: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ py: 2.25, display: 'flex', flexDirection: 'column' }}>
            <Box sx={{ mb: 2.5, display: 'flex', alignItems: 'center' }}>
              <Typography sx={{ color: 'text.secondary' }}>Today: {today.toDateString()}</Typography>
            </Box>
          ...
          <Box sx={{ py: 2.25, display: 'flex', alignItems: 'flex-end', flexDirection: 'column' }}>
            <Box sx={{ mb: 2.5, display: 'flex', alignItems: 'center' }}>
              <Typography sx={{ mr: 1.5, color: 'text.secondary' }}> Yesterday: {yesterday.toDateString()}</Typography>
            </Box>
