...
// ** Type Import
import { CardWeeklyReportProps } from 'src/@core/components/card-statistics/types'
...
const CardWeeklyReport = (props: CardWeeklyReportProps) => {
  // ** Props
  const {
    sx,
    title2,
...
export default CardWeeklyReport
